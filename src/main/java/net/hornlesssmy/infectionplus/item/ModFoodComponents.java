...
public class ModFoodComponents {
    ...
    public static final FoodComponent GHOSTLY_FISH = new FoodComponent.Builder()
            ...
            .statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 200, 2, false, false), 1.0f)
            .statusEffect(new StatusEffectInstance(StatusEffects.SATURATION, 200, 4, false, false), 1.0f)
            .statusEffect(new StatusEffectInstance(StatusEffects.WATER_BREATHING, 6000, 0, false, false), 1.0f)
            .statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 6000, 4, false, false), 1.0f).build();
}